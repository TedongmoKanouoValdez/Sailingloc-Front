...
export default function PayementClient() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto p-6 text-black text-center mt-20 backdrop-blur-md rounded-xl shadow-lg">
        <div className="mb-10">
          <h1 className="text-4xl font-extrabold mb-2 text-black drop-shadow">SailingLoc</h1>
          <h2 className="text-2xl drop-shadow">
            a demandé le paiement de <span className="font-bold">{amount.toFixed(2)} €</span>
          </h2>
        </div>
